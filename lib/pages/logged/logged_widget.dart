              ...
              children: [
                Expanded(
                  child: FutureBuilder<ApiCallResponse>(
                    future: ProductCatalogAPIGroup.getAllProductsCall.call(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final gridViewGetAllProductsResponse = snapshot.data!;

                      return Builder(
                        builder: (context) {
                          final item = (gridViewGetAllProductsResponse.jsonBody
                                      .toList()
                                      .map<ProdutoStruct?>(
                                          ProdutoStruct.maybeFromMap)
                                      .toList() as Iterable<ProdutoStruct?>)
                                  .withoutNulls
                                  .toList() ??
                              [];
