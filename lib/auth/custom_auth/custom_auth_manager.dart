...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    exXaAuthUserSubject.add(
      ExXaAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<ExXaAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  ExXaAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = ExXaAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    exXaAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
