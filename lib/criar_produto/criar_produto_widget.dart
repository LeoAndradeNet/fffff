            ...
            child: Column(
              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: () async {
                    _model.addProduct =
                        await ProductCatalogAPIGroup.addProductCall.call(
                      name: _model.txtNomeTextController.text,
                      bearerAuth: currentAuthenticationToken,
                    );

                    _model.uploadImagem = await ProductCatalogAPIGroup
                        .uploadImageProductCall
                        .call(
                      productId: ProductCatalogAPIGroup.addProductCall.id(
                        (_model.addProduct?.jsonBody ?? ''),
                      ),
                      bearerAuth: currentAuthenticationToken,
                      image: _model.uploadedLocalFile,
                    );

                    if ((_model.uploadImagem?.succeeded ?? true)) {
                      context.safePop();
                    }
